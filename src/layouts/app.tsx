...
import { SidebarMenuItem } from "./components/slider-menu";
...
function AppLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="w-full h-screen flex bg-background">
      {/* Sidebar */}
      <Sidebar collapsible="icon" className="bg-card border-none min-w-[80px]">
      ...
      <div className="w-full h-full m-auto overflow-y-auto px-8 py-4">
        <div className="w-full max-w-[1600px] m-auto bg-neutral-100 dark:bg-neutral-900 rounded-2xl p-4 flex justify-between items-center">
