...
const NeonBadge = ({
  ...
  return (
    <div
      className={`inline-flex items-center px-3 py-1.5 text-sm font-medium rounded-full backdrop-blur-md bg-black/40 border-2 shadow-2xl hover:shadow-3xl transition-all duration-300 ${colors[color]} ${className}`}
      {...props}
    >
      {children}
    </div>
...
export const BadgeStyles = {
  ...
  MetallicBadge,
  GoldBadge,
  CustomBadge: GlassBadge, // Default export
  Badge,
  CalendarIcon,
  SendIcon,
  StarIcon,
