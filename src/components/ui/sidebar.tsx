...
function Sidebar({
  ...
  return (
    <div
      className={clsx("group peer text-sidebar-foreground hidden md:block", glassMode ? "bg-transparent" : "bg-sidebar")}
      data-state={state}
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeftIcon className="w-full text-black dark:text-white" />
