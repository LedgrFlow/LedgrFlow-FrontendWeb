...
import {
  ...
  SelectComponent,
  SwitchComponent,
} from "@/views/settings/components/inputs";
...
export function SettingsEditorSection() {
  ...
  return (
    <section className="w-full h-full flex justify-between gap-5 items-center bg-neutral-50 dark:bg-neutral-900 rounded-2xl p-7 py-8">
